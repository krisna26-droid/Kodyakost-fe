...
onMounted(async () => {
  loading.value = true;
  try {
    // Memanggil data statistik dari ownerService
    ...
    // [UPDATE] Menggunakan notify.error untuk memberi tahu pemilik jika data gagal dimuat
    notify.error("Gagal memuat statistik terbaru dari server.");
  } finally {
    loading.value = false;
  }
});
  ...
  <div class="owner-dashboard">
    <div class="container">
      ...
      <div v-else class="stats-grid">
        ...
        <div class="stat-card orange-card" @click="$router.push({ name: 'owner-bookings' })" style="cursor: pointer;">
          <div class="icon-box">
...
<style scoped>
/* Tambahan Style untuk Skeleton Loading agar lebih halus */
.stat-card.skeleton {
  background: #f1f5f9;
...
.icon-box.gray { background: #e2e8f0; }
